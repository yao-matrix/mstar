...
class NodeSubmodule(torch.nn.Module):
    ...
    def forward(
        ...
        **kwargs # coming from preprocess output
        ...
        Compilable + accelerator-graphable.
        """
        pass
    ...
    def get_piecewise_accelerator_graph_configs(
        ...
        forward (e.g. a transformer block loop) as a accelerator graph while the
    ...
    def can_use_accelerator_graphs(
        ...
        """Return True if this submodule supports accelerator graphs for ``batch``.
        ...
        if not hasattr(self, "_cached_accelerator_graph_walks"):
            ...
            for cfg in self.get_accelerator_graph_configs(device=device, tp_world_size=1):
